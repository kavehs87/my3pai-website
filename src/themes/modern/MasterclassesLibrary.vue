    ...
    <template v-else-if="hasProfile">
      ...
      <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 p-4 lg:p-8 pt-24 lg:pt-8">
        ...
        <div class="lg:col-span-9 xl:col-span-9 space-y-8 pb-20">
            ...
            <div class="flex flex-col md:flex-row justify-between gap-6 md:items-end mb-6">
              <div class="max-w-xl">
                <div class="flex items-center gap-2 mb-2">
                  ...
                  <span class="bg-purple-100 text-purple-700 px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wide">
                    Training & Education
                  </span>
                </div>
                <h1 class="text-3xl font-bold text-slate-900 mb-3">Training & Masterclasses</h1>
          ...
          <div v-else-if="masterclasses.length === 0" class="bg-white rounded-3xl p-12 border border-slate-100 shadow-sm text-center">
            <div class="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <GraduationCap class="w-8 h-8 text-slate-400" />
            </div>
            <h3 class="text-xl font-bold text-slate-900 mb-2">No masterclasses found</h3>
            <p class="text-slate-500">No masterclasses available yet.</p>
          </div>
